...
*/
  ...
  public void shouldGetRestaurantDetailsByGivenName() throws Exception {
    ...
    final String responseString = mockMvc
        .perform(get("/restaurant/name/someRestaurantName")
            .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(status().isOk())
        .andReturn().getResponse().getContentAsString();

    final RestaurantListResponse restaurantListResponse = new ObjectMapper()
        .readValue(responseString, RestaurantListResponse.class);
    ...
    assertEquals(restaurantList.getAddress().getId().toString(),
        restaurantEntity.getAddress().getUuid());
    assertEquals(restaurantList.getAddress().getState().getId().toString(),
  ...
  public void shouldNotGetRestaurantByNameIfNameIsEmpty() throws Exception {
    when(mockRestaurantService.restaurantsByName(anyString()))
        .thenThrow(new RestaurantNotFoundException("RNF-003",
...
/*
  ...
  public void shouldGetRestaurantDetailsByGivenCategoryId() throws Exception {
    ...
    final String responseString = mockMvc
        .perform(get("/restaurant/category/someCategoryId")
            .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(status().isOk())
        .andReturn().getResponse().getContentAsString();
  ...
  public void shouldNotGetRestaurantByCategoryidIfCategoryIdIsEmpty() throws Exception {
    ...
    mockMvc
        .perform(get("/restaurant/category/emptyString")
            .contentType(MediaType.APPLICATION_JSON_UTF8_VALUE))
        .andExpect(status().isNotFound())
...
*/
  ...
  private RestaurantEntity getRestaurantEntity() {
    ...
    final AddressEntity addressEntity = new AddressEntity(addressId, "a/b/c", "someLocality",
        "someCity", "100000", stateEntity);
